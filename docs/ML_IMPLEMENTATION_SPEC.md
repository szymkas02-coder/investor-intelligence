...
> **SUPERSEDED** — Design specification written in session 7 (2026-05-06) before implementation.
> All models described here are now built and live. The LightGBM regime model referenced here
> was later deleted (circular labels). See [`ML_REFERENCE.md`](ML_REFERENCE.md) for current model docs.
